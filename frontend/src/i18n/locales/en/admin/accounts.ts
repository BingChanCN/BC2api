export default {
    accounts: {
      ...
      managedProxy: {
        ...
        blocked: 'Blocked',
        rotate: 'Rotate now',
        rotated: 'Managed proxy rotated',
        rotateFailed: 'Failed to rotate managed proxy',
        migrate: 'Migrate configuration',
        targetProvider: 'Target configuration',
        migrated: 'Managed proxy migrated',
        migrateFailed: 'Failed to migrate managed proxy',
        release: 'Leave managed mode',
        releaseConfirm: 'Leaving managed mode clears the proxy binding. Subsequent requests will connect to the upstream directly from the server. Continue?',
        released: 'Account left managed proxy mode',
        releaseFailed: 'Failed to leave managed proxy mode',
        editLocked: 'Managed proxies cannot be replaced here. Use migrate configuration or leave managed mode.'
      },
      managedProxyImport: {
        title: 'Proxy assignment',
        none: 'No proxy',
        file: 'Use file proxies',
        managed: 'CatProxies managed',
        provider: 'Provider configuration',
        default: 'Default',
        country: 'Country',
        state: 'State',
        city: 'City',
        providerDefault: 'Use provider defaults',
        any: 'Any',
        strict: 'Strict location matching',
        probeHint: 'Before import, {count} dedicated sticky proxies will be probed. Accounts whose probes fail are not written.',
        providerRequired: 'Select an active CatProxies configuration',
        resultStatus: { created: 'Created', proxy_probe_failed: 'Proxy probe failed', invalid: 'Invalid data', failed: 'Creation failed' }
      },
