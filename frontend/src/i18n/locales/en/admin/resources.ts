export default {
    ...
    proxies: {
      ...
      tabs: { static: 'Static Proxies', managed: 'Managed Proxies' },
      managed: {
        search: 'Search configurations or hosts',
        allStatuses: 'All statuses',
        create: 'Add managed configuration',
        edit: 'Edit managed configuration',
        empty: 'No managed proxy configurations',
        default: 'Default',
        details: 'Bound accounts',
        test: 'Test route',
        noTarget: 'No location target',
        any: 'Any',
        ready: 'Ready',
        blocked: 'Scheduling blocked',
        noAccounts: 'No accounts are bound to this configuration',
        keepPassword: 'Leave blank to keep the current password',
        loadFailed: 'Failed to load managed proxies',
        saved: 'Managed proxy configuration saved',
        saveFailed: 'Failed to save managed proxy configuration',
        testSuccess: 'Route available: {ip}, {latency} ms',
        testFailed: 'Route test failed',
        deleted: 'Managed proxy configuration deleted',
        deleteFailed: 'Failed to delete managed proxy configuration',
        deleteTitle: 'Delete managed proxy configuration',
        deleteMessage: 'Delete “{name}”? The server will reject deletion while accounts remain bound.',
        status: { active: 'Active', retiring: 'Retiring', disabled: 'Disabled', credential_error: 'Credential error' },
        columns: { name: 'Configuration', status: 'Status', endpoint: 'Gateway', target: 'Default target', lifetime: 'Sticky window', lastProbe: 'Last probe', accounts: 'Accounts', health: 'Ready / blocked' },
        fields: { name: 'Configuration name', protocol: 'Protocol', host: 'Gateway host', username: 'Base username', password: 'Order password', country: 'Default country', state: 'Default state', city: 'Default city', lifetime: 'Sticky lifetime (minutes)', default: 'Set as default', strict: 'Strict location matching' },
        detail: { account: 'Account', region: 'Observed region', latency: 'Latency', nextRotation: 'Next rotation' }
      },
