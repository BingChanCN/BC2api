export default {
  ...
  availableChannels: {
    ...
    rateCeilingTitle: 'Rate ceilings',
    rateCeilingDesc: 'Set the highest billing rate you accept per channel (group). Requests are rejected when the current rate exceeds your ceiling. Leave empty for no limit.',
    rateCeiling: 'Ceiling',
    rateCeilingUnlimited: 'No limit',
    rateCeilingInvalid: 'Ceiling must be greater than 0',
    rateCeilingSaved: 'Rate ceiling saved',
    clearCeiling: 'Clear',
  ...
  redeem: {
    ...
    balanceAddedGame: 'Balance Added (Game)',
    balanceDeductedGame: 'Balance Deducted (Game)',
