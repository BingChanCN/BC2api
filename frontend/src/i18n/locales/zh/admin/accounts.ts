export default {
    accounts: {
      ...
      managedProxy: {
        ...
        targetProvider: '目标配置',
        migrated: '受管代理已迁移',
        migrateFailed: '迁移受管代理失败',
        release: '退出托管',
        releaseConfirm: '退出托管会清除代理绑定，后续请求将由服务器直接连接上游。确定继续吗？',
        released: '账号已退出代理托管',
        releaseFailed: '退出代理托管失败',
        editLocked: '受管代理不可在普通编辑中替换，请使用迁移配置或退出托管。'
      },
      managedProxyImport: {
        title: '代理分配',
        none: '不使用代理',
        file: '文件自带',
        managed: 'CatProxies 受管',
        provider: '供应商配置',
        default: '默认',
        country: '国家',
        state: '州',
        city: '城市',
        providerDefault: '使用配置默认值',
        any: '任意',
        strict: '严格地区匹配',
        probeHint: '导入前将同步探测 {count} 个账号的独立粘性代理；探测失败的账号不会写入数据库。',
        providerRequired: '请选择可用的 CatProxies 配置',
        resultStatus: { created: '创建成功', proxy_probe_failed: '代理探测失败', invalid: '数据无效', failed: '创建失败' }
      },
