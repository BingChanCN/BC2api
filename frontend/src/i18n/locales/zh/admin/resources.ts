export default {
    ...
    proxies: {
      ...
      managed: {
        ...
        ready: '正常',
        blocked: '已阻止调度',
        noAccounts: '此配置尚未绑定账号',
        keepPassword: '留空保持原密码',
        loadFailed: '加载受管代理失败',
        saved: '受管代理配置已保存',
        saveFailed: '保存受管代理配置失败',
        testSuccess: '线路可用：{ip}，{latency} ms',
        testFailed: '线路测试失败',
        deleted: '受管代理配置已删除',
        deleteFailed: '删除受管代理配置失败',
        deleteTitle: '删除受管代理配置',
        deleteMessage: "确定要删除配置“{name}”吗？仍有绑定账号时服务器会拒绝删除。",
        status: { active: '启用', retiring: '退役中', disabled: '已停用', credential_error: '凭据异常' },
        columns: { name: '配置', status: '状态', endpoint: '网关', target: '默认地域', lifetime: '粘性窗口', lastProbe: '最近探测', accounts: '账号', health: '正常 / 异常' },
        fields: { name: '配置名称', protocol: '协议', host: '网关主机', username: '基础用户名', password: '订单密码', country: '默认国家', state: '默认州', city: '默认城市', lifetime: '粘性时长（分钟）', default: '设为默认配置', strict: '严格地区匹配' },
        detail: { account: '账号', region: '实际地域', latency: '延迟', nextRotation: '下次轮换' }
      },
      createProxy: '添加代理',
      editProxy: '编辑代理',
      deleteProxy: '删除代理',
