export default {
  ...
  availableChannels: {
    ...
    rateCeilingTitle: '倍率上限',
    rateCeilingDesc: '按渠道（分组）设置你可接受的最高计费倍率。当前倍率超过上限时请求会被拒绝；留空表示不限制。',
    rateCeiling: '上限',
    rateCeilingUnlimited: '不限制',
    rateCeilingInvalid: '上限必须大于 0',
    rateCeilingSaved: '倍率上限已保存',
    clearCeiling: '清除',
    currentRate: '当前倍率',
    columns: {
      name: '渠道名',
  ...
  redeem: {
    ...
    balanceAddedGame: '余额增加（游戏）',
    balanceDeductedGame: '余额扣除（游戏）',
